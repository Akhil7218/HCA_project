...
## Sample Visual Results & Clinical Diagnostic Reports

Below are sample inference results and generated clinical reports for test Chest X-Ray scans. Each entry shows the **Grad-CAM Saliency Heatmap Overlay** alongside the **Generated Clinical Report Script** synthesized by Gemini AI.

### Pneumonia Positive Cases

| Scan Description | Prediction | Confidence | Dominant Quadrant | Grad-CAM Heatmap Overlay | Generated Clinical Report Script |
| :--- | :---: | :---: | :---: | :---: | :---: |
| **Bacterial Pneumonia** (`person1002_bacteria_2933.jpeg`) | **PNEUMONIA** | **99.81%** | Right Upper Lobe | ![Bacterial Pneumonia Overlay](docs/results/result_person1002_bacteria_2933.png) | ![Bacterial Pneumonia Script](docs/results/Script-person1002_bacteria_2933.png) |
| **Viral Pneumonia** (`person1007_virus_1690.jpeg`) | **PNEUMONIA** | **98.00%** | Right Upper Lobe | ![Viral Pneumonia Overlay](docs/results/result_person1007_virus_1690.png) | ![Viral Pneumonia Script](docs/results/Script-person1007_virus_1690.png) |
...
| Scan Description | Prediction | Confidence | Dominant Quadrant | Grad-CAM Heatmap Overlay | Generated Clinical Report Script |
| :--- | :---: | :---: | :---: | :---: | :---: |
| **Normal Chest X-Ray** (`IM-0028-0001.jpeg`) | **NORMAL** | **0.39%** | Clear / None | ![Normal Overlay 1](docs/results/result_IM-0028-0001.png) | ![Normal Script 1](docs/results/Script-0028-0001.png) |
| **Normal Chest X-Ray** (`IM-0029-0001.jpeg`) | **NORMAL** | **0.01%** | Clear / None | ![Normal Overlay 2](docs/results/result_IM-0029-0001.png) | ![Normal Script 2](docs/results/Script-0029-0001.png) |
| **Normal Chest X-Ray** (`IM-0079-0001.jpeg`) | **NORMAL** | **3.27%** | Clear / None | ![Normal Overlay 3](docs/results/result_IM-0079-0001.png) | ![Normal Script 3](docs/results/Script-0079-0001.png) |
...
├── docs/
│   └── results/                  # Generated sample Grad-CAM heatmap overlays & clinical report screenshots
├── frontend/
